        ...
        _this.submitSearch = function () {
            ...
            for (var i = 0; i < Math.min(MAX_MOTIF_SIZE, loci.length); i++) {
                ...
                if (!determineBackboneAtom(structure, elements[0])) {
                    alert("No CA or C4' atom for ".concat(structure_1.StructureProperties.residue.label_seq_id(location), " | ").concat(structure_1.StructureProperties.chain.label_asym_id(location), " | ").concat(struct_oper_id));
                    return;
                }
