...
export declare type ModelUrlProvider = (pdbId: string) => {
    url: string;
...
export declare type CollapsedState = {
    selection: boolean;
...
export declare function ViewerState(plugin: PluginContext): ViewerState;
export {};
