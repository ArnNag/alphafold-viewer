...
export declare type SelectBase = {
    readonly modelId: string;
    readonly labelAsymId: string;
    readonly operatorName?: string;
};
export declare type SelectSingle = {
    readonly labelSeqId: number;
} & SelectBase;
export declare type SelectRange = {
    readonly labelSeqRange: Range;
} & SelectBase;
export declare type SelectTarget = SelectSingle | SelectRange;
export declare type SelectionExpression = {
    tag: string;
