...
//                 return [plddtLabel(loci)].filter(l => !!l).join('</br>');
//             }
//         };
//
//         register(): void {
...
//     id: 'preset-structure-representation-rscc',
//     display: {
//         name: 'Quality Assessment (RSCC)', group: 'Annotation',
//         description: 'Color structure based on Real-Space Correlation Coefficients (RSCC).'
//     },
//     isApplicable(a) {
//         return !!a.data.models.some(m => RSCC.isApplicable(m));
//     },
