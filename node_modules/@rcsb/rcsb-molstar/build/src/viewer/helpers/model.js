        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        trajectory = _a.sent();
                        if (!reprProvider) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.plugin.builders.structure.hierarchy.applyPreset(trajectory, reprProvider, tslib_1.__assign({}, params))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, this.plugin.builders.structure.hierarchy.applyPreset(trajectory, preset_1.RcsbPreset, {
                            preset: props || { kind: 'standard', assemblyId: '' }
                        })];
                    case 4:
                        selector = _a.sent();
                        if (!(matrix && (selector === null || selector === void 0 ? void 0 : selector.structureProperties))) return [3 /*break*/, 6];
                        params_1 = {
                            transform: {
                                name: 'matrix',
