...
export declare type PLDDTConfidence = PropertyWrapper<{
    score: IndexedCustomProperty.Residue<[number, string]>;
    category: string[];
}>;
export declare namespace PLDDTConfidence {
    ...
    function fromCif(ctx: CustomProperty.Context, model: Model): PLDDTConfidence | undefined;
    function obtain(ctx: CustomProperty.Context, model: Model, _props: PLDDTConfidenceProps): Promise<CustomProperty.Data<any>>;
    function getConfidenceScore(e: StructureElement.Location): [number, string];
    function getCategories(structure?: Structure): string[];
}
export declare const PLDDTConfidenceParams: {};
export declare type PLDDTConfidenceParams = typeof PLDDTConfidenceParams;
export declare type PLDDTConfidenceProps = PD.Values<PLDDTConfidenceParams>;
export declare const PLDDTConfidenceProvider: CustomModelProperty.Provider<PLDDTConfidenceParams, PLDDTConfidence>;
