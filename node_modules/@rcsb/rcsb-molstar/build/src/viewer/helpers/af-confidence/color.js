...
exports.AlphaFoldConfidenceColorThemeProvider = exports.AlphaFoldConfidenceColorTheme = exports.getAlphaFoldConfidenceColorThemeParams = void 0;
...
function getAlphaFoldConfidenceColorThemeParams(ctx) {
    var categories = prop_1.AlphaFoldConfidence.getCategories(ctx.structure);
...
exports.getAlphaFoldConfidenceColorThemeParams = getAlphaFoldConfidenceColorThemeParams;
function AlphaFoldConfidenceColorTheme(ctx, props) {
    var color = function () { return DefaultColor; };
    if (ctx.structure && ctx.structure.models.length > 0 && ctx.structure.models[0].customProperties.has(prop_1.AlphaFoldConfidenceProvider.descriptor)) {
        var getColor_1 = function (location) {
            var score = prop_1.AlphaFoldConfidence.getConfidenceScore(location)[1];
...
exports.AlphaFoldConfidenceColorTheme = AlphaFoldConfidenceColorTheme;
exports.AlphaFoldConfidenceColorThemeProvider = {
    name: 'af-confidence',
    label: 'AlphaFold Confidence',
    category: "Validation" /* Validation */,
    factory: AlphaFoldConfidenceColorTheme,
    getParams: getAlphaFoldConfidenceColorThemeParams,
    defaultValues: param_definition_1.ParamDefinition.getDefaultValues(getAlphaFoldConfidenceColorThemeParams({})),
    isApplicable: function (ctx) { var _a; return prop_1.AlphaFoldConfidence.isApplicable((_a = ctx.structure) === null || _a === void 0 ? void 0 : _a.models[0]); },
    ensureCustomProperties: {
        attach: function (ctx, data) { return data.structure ? prop_1.AlphaFoldConfidenceProvider.attach(ctx, data.structure.models[0], void 0, true) : Promise.resolve(); },
        detach: function (data) { return data.structure && prop_1.AlphaFoldConfidenceProvider.ref(data.structure.models[0], false); }
    }
};
