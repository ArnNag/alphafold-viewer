...
exports.TrajectoryIndexColorThemeParams = tslib_1.__assign({}, (0, palette_1.getPaletteParams)({ type: 'colors', colorList: 'purples' }));
...
exports.TrajectoryIndexColorThemeProvider = {
    ...
    isApplicable: function (ctx) { return !!ctx.structure && ctx.structure.elementCount > 0 && structure_1.Model.TrajectoryInfo.get(ctx.structure.models[0]).size > 1; }
};
