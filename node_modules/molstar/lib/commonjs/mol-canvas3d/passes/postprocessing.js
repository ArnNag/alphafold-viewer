...
var PostprocessingPass = /** @class */ (function () {
    ...
    PostprocessingPass.prototype.updateState = function (camera, transparentBackground, backgroundColor, props, light) {
        ...
        if (props.shadow.name === 'on') {
            ...
            mol_util_1.ValueCell.updateIfChanged(this.shadowsRenderable.values.dOrthographic, orthographic);
        ...
        mol_util_1.ValueCell.updateIfChanged(this.renderable.values.dShadowEnable, shadowsEnabled);
