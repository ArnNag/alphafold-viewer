...
(function (Canvas3D) {
    function create(_a, props) {
        ...
        var controls = trackball_1.TrackballControls.create(input, camera, p.trackball);
        ...
        var interactionHelper = new interaction_events_1.Canvas3dInteractionHelper(identify, getLoci, input, camera, p.interaction);
