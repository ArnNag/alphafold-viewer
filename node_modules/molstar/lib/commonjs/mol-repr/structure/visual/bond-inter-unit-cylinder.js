...
function getInterUnitBondCylinderBuilderProps(structure, theme, props) {
    var locE = structure_1.StructureElement.Location.create(structure);
    var locB = structure_1.Bond.Location(structure, undefined, undefined, structure, undefined, undefined);
    ...
    var delta = (0, linear_algebra_1.Vec3)();
    var stub;
