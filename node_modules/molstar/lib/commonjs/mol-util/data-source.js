...
var nodejs_shims_1 = require("./nodejs-shims");
...
function isDone(data) {
    if (!nodejs_shims_1.RUNNING_IN_NODEJS && data instanceof FileReader) { // FileReader is not available in Node.js
        return data.readyState === FileReader.DONE;
    }
    else if (data instanceof nodejs_shims_1.XMLHttpRequest_) {
        return data.readyState === nodejs_shims_1.XMLHttpRequest_.DONE;
    }
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (isDone(data)) {
            ...
            if (error !== null && error !== undefined) {
                reject(error !== null && error !== void 0 ? error : genericError(data instanceof nodejs_shims_1.XMLHttpRequest_));
            }
            else {
                resolve(data);
            }
...
function readFromFileInternal(file, type) {
    ...
    var reader = void 0;
    return mol_task_1.Task.create('Read File', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
var RequestPool = /** @class */ (function () {
    ...
    RequestPool.get = function () {
        ...
        return new nodejs_shims_1.XMLHttpRequest_();
    };
...
function ajaxGetInternal(title, url, type, body, headers) {
    var _this = this;
    if (nodejs_shims_1.RUNNING_IN_NODEJS && url.startsWith('file://')) {
        return ajaxGetInternal_file_NodeJS(title, url, type, body, headers);
    }
    var xhttp = void 0;
    return mol_task_1.Task.create(title ? title : 'Download', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
function ajaxGetInternal_file_NodeJS(title, url, type, body, headers) {
    ...
    var file = new nodejs_shims_1.File_([data], 'raw-data');
