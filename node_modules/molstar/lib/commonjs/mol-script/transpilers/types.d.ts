...
export declare type KeywordDict = {
    [name: string]: Keyword;
};
...
export declare type PropertyDict = {
...
export declare type OperatorList = Operator[];
export interface Function {
    '@desc': string;
    '@examples': string[];
    map?: (x: any) => Expression;
}
export declare type FunctionDict = {
