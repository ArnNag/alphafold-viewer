...
export function getDrawBuffersIndexed(gl) {
...
export function getDisjointTimerQuery(gl) {
    if (isWebGL2(gl)) {
...
export function getParallelShaderCompile(gl) {
...
export function getFboRenderMipmap(gl) {
    return isWebGL2(gl) ? {} : gl.getExtension('OES_fbo_render_mipmap');
}
export function getProvokingVertex(gl) {
    if (isWebGL2(gl)) {
...
export function getNoNonInstancedActiveAttribs(gl) {
    if (!isWebGL2(gl))
        return false;
