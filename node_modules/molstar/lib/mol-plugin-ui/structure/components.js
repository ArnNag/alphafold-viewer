...
var AddComponentControls = /** @class */ (function (_super) {
    ...
    AddComponentControls.prototype.render = function () {
        return _jsxs(_Fragment, { children: [_jsx(ParameterControls, { params: this.state.params, values: this.state.values, onChangeValues: this.paramsChanged }), _jsx(Button, __assign({ icon: AddSvg, title: 'Use Selection and optional Representation to create a new Component.', className: 'msp-btn-commit msp-btn-commit-on', onClick: this.apply, style: { marginTop: '1px' } }, { children: "Create Component" }))] });
    };
...
var ComponentListControls = /** @class */ (function (_super) {
    ...
    ComponentListControls.prototype.render = function () {
        ...
        if (componentGroups.length === 0)
            return null;
        return _jsx("div", __assign({ style: { marginTop: '6px' } }, { children: componentGroups.map(function (g) { return _jsx(StructureComponentGroup, { group: g }, g[0].cell.transform.ref); }) }));
    };
...
var StructureComponentGroup = /** @class */ (function (_super) {
    ...
    function StructureComponentGroup() {
        ...
        _this.focus = function () {
            ...
            }, getPcaTransform(_this.props.group));
        };
