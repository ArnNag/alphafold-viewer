...
$result = mysqli_query($mysqlLink, "select seq2_id, blast_log10_e, pct_identical, seq1_start, seq1_length, seq2_start, seq2_length from uniprot_seq, astral_seq_blast where 35207230 = uniprot_seq.uniprot_id and uniprot_seq.seq_id = astral_seq_blast.seq1_id group by seq2_id order by blast_log10_e;");
...
for ($x = 0; $x < $n; $x++) {
	...
	$resdata = $resdata."[".$row["seq2_start"].", ".$seq2_end."], ";
} 
